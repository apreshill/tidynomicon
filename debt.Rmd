...
```{r}
levels(raw$flavor) <- c("chocolate", "strawberry", "vanilla", "mustard")
```
...
But wait: the average values have also changed.
For example, the average rating for `strawberry` is now `0.2` instead of `1.866667`.
